...
A bilingual web app for real-time project performance analysis and forecasting — built to support project managers and stakeholders with visually intuitive metrics, automated Smart Analysis reporting, and printable summaries.
...
* Generate offline, heuristic-based project performance narratives and status reports (No APIs required for complete data privacy)
...
* 🤖 **Automated Smart Summaries and stakeholder-tailored reports** (100% offline to ensure absolute data security)
...
| 🧠 **Smart Narrative & Report Generator** | Built-in heuristic engine evaluates metrics to draft context-aware reports locally | 
| 🔒 **Absolute Data Privacy** | Zero data leaves the browser; no external APIs are called | 
...
* Custom Heuristic Rule Engine (Offline Smart Analysis logic)
...
👉 <https://khanhaissam.github.io/earned-value-dashboard/>
...
```bash
git clone [https://github.com/yourusername/earned-value-dashboard.git](https://github.com/yourusername/earned-value-dashboard.git)
